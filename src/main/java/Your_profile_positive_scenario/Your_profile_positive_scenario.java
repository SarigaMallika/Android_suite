package Your_profile_positive_scenario;
...
public class Your_profile_positive_scenario extends Generic_functions{
	...
	public void yourprofile_positive_tc_001() throws Exception  {
		try {
			...
			click("profile");
			Thread.sleep(100);
			//value = driver.findElement(By.xpath(OR_reader("Object Locator","your_prof_img_icon"))).isDisplayed();
			//Assert.assertEquals(true,value);
...
//				value = driver.findElement(By.xpath(OR_reader("Object_Locator", "Your_prof_email_title"))).isDisplayed();
//				Assert.assertEquals(true,value);
//				page_wait(10);
