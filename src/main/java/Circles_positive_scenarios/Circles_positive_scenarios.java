...
public class Circles_positive_scenarios extends Generic_functions{
	...
	public void circle_positive_tc_002() throws IOException {
		try {
			page_wait(10);
			stale_click("circles_add_partner_button");
			page_wait(10);
	...
	public void circle_positive_tc_003() throws IOException {
		try {
			page_wait(10);
			stale_click("circles_add_partner_dropdown");
			stale_click("circles_mymedicare_option");
			stale_click("circles_proceed_button");
			page_wait(80);
	...
	public void circle_positive_tc_004() throws IOException {
		try {
			...
			Assert.assertEquals(true,value);
			page_wait(50);
			stale_click("circles_forgot_username_link");
			page_wait(50);
	...
	public void circle_positive_tc_005() throws IOException {
		try {
			page_wait(20);
			stale_click("circles_forgot_password_link");
	...
	public void circle_positive_tc_007() throws IOException {
		try {
			stale_click("circles_mymedicare_eye");
			stale_click("circles_mymedicare_eye");
			page_wait(40);
			stale_click("circles_mymedicare_eye");
			stale_click("circles_mymedicare_eye");
			...
			Assert.assertEquals(str,td_reader("circles_mymedicare_password",0));
	...
	public void circle_positive_tc_008() throws IOException {
		try {
			page_wait(10);
			stale_click("circles_mymedicare_login_button");
			page_wait(10);
			stale_click("circles_mymedicare_allow_button");
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void circle_positive_tc_012() throws IOException  {
		try {
			page_wait(10);
			stale_click("circles_mymedicare_button");
			stale_click("circles_mymedicare_back_arrow");
			page_wait(10);
			value = driver.findElement(By.xpath(OR_reader("circles_mymedicare_img_icon"))).isDisplayed();
			Assert.assertEquals(true,value);
			stale_click("home");
			stale_click("hamburger");
			stale_click("logout");
			close();
		} catch (Exception e) {
			e.printStackTrace();
